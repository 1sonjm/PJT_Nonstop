...
public class Portfolio{
	...
	private String portRegdate;
	private String portUpdate;
	...
	public String getPortRegdate() {
		return portRegdate;
	}
	public void setPortRegdate(String portRegdate) {
		this.portRegdate = portRegdate;
	}
	public String getPortUpdate() {
		return portUpdate;
	}
	public void setPortUpdate(String portUpdate) {

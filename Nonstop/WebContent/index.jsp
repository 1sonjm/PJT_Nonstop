                     ...
                     <div class="tab-content">
                        <div class="tab-pane active" id="tab_default_1">
                           <form id="addUserF">
                                  ...
                                  <div class="form-group">
                                      <input type="password" id="password2" name="password21" class="form-control" placeholder="Password 확인">
                                  </div>
                                  <div id="checkpw" style="color:red; font-size:12px;"></div>
                                  <div class="form-group">
                                      <input type="text" id="userName" name="userName1" class="form-control" placeholder="이름">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" id="addr" name="addr1" class="form-control" placeholder="주소">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" id="tel" name="tel1" class="form-control" placeholder="연락처">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" id="email" name="email1" class="form-control" placeholder="이메일">
                                  </div>
                        ...
                        <div class="tab-pane" id="tab_default_2">
                           <form id="addCompanyF">
                                  ...
                                  <div class="form-group">
                                      <input type="password" id="password2" name="password222" class="form-control" placeholder="Password 확인">
                                  </div>
                                  <div id="checkpw" style="color:red; font-size:12px;"></div>
                                  <div class="form-group">
                                      <input type="text" id="userName" name="userName2" class="form-control" placeholder="이름">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" id="addr" name="addr2" class="form-control" placeholder="이름">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" id="tel" name="tel2" class="form-control" placeholder="연락처">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" id="email" name="email2" class="form-control" placeholder="이메일">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" id="companyName" name="companyName2" class="form-control" placeholder="기업명">
                                  </div>
                                   <div class="form-group">
                                      <input type="text" id="empNum" name="empNum2" class="form-control" placeholder="직원수">
                                  </div>

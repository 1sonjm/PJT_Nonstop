	...
	<div class="container">
		<div class="row">
			...
			<input type="hidden" name="projNo" value="${project.projNo}" />
	    		<fieldset>			
				<!-- Form Name -->
				<legend align="center">프로젝트 수정</legend>
				...
				<div class="margin-top-30">
					...
					<div class="form-group">
					  <label for="projectDate" class="col-sm-offset-1 col-sm-2 control-label">소요기간</label>
						    <div class="col-sm-3">
						      <input type="text" class="form-control" id="projStartDate" name="projStartDate" value="${project.projStartDate}" readonly>
						    </div>
						    <div class="col-sm-3">
						      <input type="text" class="form-control" id="projEndDate" name="projEndDate" value="${project.projEndDate}" readonly>
						    </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-6">
					  	<input id="projTitle" name="projTitle" class="form-control input-md" type="text" value="${project.projTitle}">					    
					  </div>
					</div>	
					...
					<!-- Textarea -->
               		<div class="form-group">
					  	...
					  	<div class="col-md-6">                     
                         <textarea class="form-control textarea" rows="13" name="projDetail" id="projDetail" value="">${project.projDetail}</textarea>
               			</div>
               		</div>
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input class="form-control" type="text" name="projAnnoEnd" id="projAnnoEnd" value="${project.projAnnoEnd}" readonly />
						</div>
					</div>
				...
				<!-- 	<div class="form-group">
					...
					<div class="row">
						<div class="col-md-2 col-md-offset-4">
							<button type="button" class="btn btn-primary btn-block btn-lg" id="ok" tabindex="7">수&nbsp;정</button>
						</div>
						<div class="col-md-2">

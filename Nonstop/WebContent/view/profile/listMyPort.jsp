							...
							<figure class="effect-sadie">
								...
								<div class="thumbnail-portImage">
									<img src="../../resources/images/upload/${portfolio.portFile}"
										width="400px" height="300px" id="aaaa">
								</div>
								<div class="caption">
										...
										<div class="row">
											<div class="col-sm-3 text-center">
												<span> <img class="img-circle"
													src="/resources/images/upload/${portfolio.portUserImg}"
													id="aaa" width="50px" height="50px" style="height: 50px">
												</span> <input type="hidden" id="portUserId" name="portUserId"
											...
											<figcaption>
												<p class="hover__active">
													...
													<c:if test="${sessionScope.user.userId !=user.userId }">
														...
														<c:if
															test="${portfolio.scrapNo == 0 && !empty sessionScope.user}">
															<button type="button" class="Scrap"

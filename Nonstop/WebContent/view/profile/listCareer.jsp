			...
			<div class="card">
				<div class="col-md-12">
					<div class="page-header text-center">
						<h5 class=" text-left" style="padding-left: 10px; font-size: 16px">개인
							기술정보</h5>
					</div>
						...
						<c:if test="${user.userId==sessionScope.user.userId }">
							<div class="btn-group">
								<button type="button" class="btn btn-info btn-md"
									data-toggle="modal" data-target="#myModal" style="align: right">
									<i id="addViewCareer" class="fa fa-cog"></i>
								</button>
				...
				<div class="modal-body">
					<form role="form" id="addMail" class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-lg-5">
								<select class="form-control" id="selectTechClass"
									name="techClass">
									<c:forEach var="classValue" items="${techClassList}" begin="0"
										step="1">
						...
						<div class="form-group">
							...
							<div class="col-lg-5">
								<select class="form-control" id="selectTechData" name="techNo">
									<c:forEach var="career" items="${techDataList}" begin="0"
										step="1">
						...
						<div class="form-group">
							...
							<div class="col-lg-7">
								<input type="text" name="careerUseTerm"
									placeholder="개월단위로 입력해 주세요. ex)24" class="form-control">
							</div>
						</div>

	 ...
	 <div class="mail-box">
                      ...
                      <div class="user-head">
                          <a class="inbox-avatar" href="javascript:;">
                              <%-- <img  width="64" hieght="60" src="resources/images/upload/${user.image}"> --%>
                          </a>
                          <div class="user-name">
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          ...
                                          <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                      <input type="text"class="form-control" name="sendId" value = "${sessionScope.user.userId}" readOnly>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                      <input type="text" placeholder="수신자를 입력하세요" name="receiveId" id="inputEmail1" class="form-control">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                      <input type="text" name="letTitle" placeholder="메일 제목을 입력하세요" class="form-control">
                                                  </div>
                                              </div>
                      ...
                      <ul class="inbox-nav inbox-divider">
                          <li ><!-- class="active" -->
                              <a href="#"><i class="fa fa-inbox" id="inBox" receiveId="${sessionScope.user.userId}">받은 메일함</i>  <!-- <span class="label label-danger pull-right">2</span> --></a>
                          ...
                          <li>
                              <a href="#"><i class="fa fa-bookmark-o" id="save"></i>중요한메일</a>
                          </li>
                          <!-- <li>
                 ...
                 <ul class="nav nav-pills nav-stacked labels-info inbox-divider">
                      ...
                      <div class="inbox-body">
                          ...
                          <table class="table table-inbox table-hover">
                              ...
                              <i id="${letter.letNo }" save="${letter.letSave}" letNo="${letter.letNo}" class="fa fa-star"></i>
                              
                              </c:if>
                              
                              <c:if test="${letter.letSave==1}">
                              
                              <i id="${letter.letNo }" save="${letter.letSave}" letNo="${letter.letNo}" class="fa fa-star inbox-started"></i>
                               ...
                               <div class="form-group">
                                     ...
                                     <label class="col-lg-2 control-label">Title</label>
                                       <div class="col-lg-10">
                                       <input class="form-control" name="sendId" value = " ${letter.letTitle}" readOnly>
		    					...
		    					<br/><br/>
                                 <div class="form-group">
                                     <label class="col-lg-2 control-label">From</label>
                                       <div class="col-lg-10">
                                         <input class="form-control" name="sendId" value = " ${letter.sendId}" readOnly>
                                       </div>
                                 </div>
                                 ...
                                 <br/>
                                     <label class="col-lg-2 control-label">To</label>
                                        <div class="col-lg-10">
                                           <input  value="${letter.receiveId}" name="receiveId" id="inputEmail1" class="form-control" readOnly>
                                        </div>
                                 </div>
		    				...
		    				<div class="form-group">
                                 <label class="col-lg-2 control-label">Mail</label>
                                       <div class="col-lg-10">
                                              <textarea rows="10" cols="30" name="letDetail" class="form-control"readonly>${letter.letDetail}</textarea>
                                       </div>
                            </div>
		   						 ...
		   						 <c:if test="${sessionScope.user.userId.trim() != letter.sendId.trim()}">
							   	   <button type="button" class="btn btn-right-primary"   letNo="${letter.letNo}"  data-toggle="modal" data-target="#myModal2"> 답장하기 </button>
							   	   </c:if>
					 ...
					 <div class="modal-body">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">To</label>
                                                  <div class="col-lg-10">
                                                      <input type="text" value="${letter.sendId}" name="receiveId" id="inputEmail1" class="form-control" readOnly>
                                                  </div>
                                              </div>
								 	...
								 	<button type="button" class="btn btn-primary-right" receiveId="${sessionScope.user.userId}"  id="close" > 이전 </button>
								 	</div>
							    </div>
                              </td>
                          </tbody>

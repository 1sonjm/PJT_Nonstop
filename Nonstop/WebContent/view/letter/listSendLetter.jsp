 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      ...
                      <ul class="inbox-nav inbox-divider">
                          ...
                          <li>
                              <a href="#" id="saveBox" userId="${sessionScope.user.userId}" ><i class="fa fa-bookmark-o" >보관메일함</i></a>
                          </li>
                          <!-- <li>
							...
							<c:if test="${letter.letSendView==0}">
							 <c:if test="${letter.letReaddate==null}">
                              ...
                              <tr class="read">
                              	...
                              	<%-- <div id="getLetter" letNo="${letter.letNo}" receiveId="${letter.receiveId}"> --%>
                                  <td class="inbox-small-cells">
                                      <input type="checkbox" name="chbox" value="${letter.letNo}" class="mail-checkbox">
                                  </td>
                                  <td class="inbox-small-cells"></td>
                                  <td class="view-message" letNo="${letter.letNo}" receiveId="${letter.receiveId}">${letter.receiveId}</td>
